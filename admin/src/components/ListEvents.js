...
function ListEvents() {
  ...
  return (
    <div className="row" style={{ minHeight: window.innerHeight }}>
      <div className="row" style={{ marginTop: "70px", marginBottom: "auto" }}>
        <div className="col-8">
          <h1>List Events</h1>
        </div>
        <div className="col-4">
          {" "}
          <Link to="/AddEvent" onClick={clearEvent}>
        ...
        <div style={{ height: height - 150, width: "100%" }}>
